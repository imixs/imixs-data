...
public class IMAPImportHelper {
     ...
     * "application/octet" which is not a valid content type. Also in this case we
     * return true!
     * 
     * @param contentType
     * @return
     ...
     * characters (dots, spaces) around the slash separator. This method cleans up
     * these common formatting errors to ensure proper content type recognition.
     *
     * Common fixes applied: - application/.pdf → application/pdf - text /html →
     * text/html - image. /jpeg → image/jpeg - application . /pdf → application/pdf
     *
